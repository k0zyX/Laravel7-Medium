    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="{{ url("/panel") }}">ZGENCYBER</a>
        </div>
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="{{ url("/panel/addpost") }}">
                <span class="menu-title">Add Post</span>
                <i class="mdi mdi-library-plus menu-icon"></i>
              </a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="{{ url("/panel/remove") }}">
                <span class="menu-title">Remove Post</span>
